...
class ChatListPage extends GetView<MessagePageController> {
      ...
      body: CustomBody(
        ...
        appBar: Container(
          ...
          child: GestureDetector(
            onTap: controller.addMessageItem,
            child: Text(
              'MESSAGE',
              style: TextStyle(
                fontSize: 24.sp,
        ...
        body: SlidableAutoCloseBehavior(
          child: AnimatedList(
            ...
            initialItemCount: controller.chatMessageList.length,
            itemBuilder: (context, index, animation) {
              return _buildChatMessageListItem(context, index, animation,
                  controller.chatMessageList[index], controller);
            },
          ),
        ),
      ),
...
Widget _buildChatMessageListItem(
  ...
  return GestureDetector(
    onTap: () => controller.goToChatIngPage(index),
    child: SizeTransition(
      ...
      child: Slidable(
        ...
        endActionPane: ActionPane(
          ...
          children: [
            SlidableAction(
              onPressed: (context) => controller.removeMessageItem(index),
...
Widget buildRemovedItem(MessageListItemVO vo, Animation<double> animation) {
