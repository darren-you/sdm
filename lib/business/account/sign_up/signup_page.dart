...
/// 登陆输入
Widget inputAccountInfo(BuildContext context, SignupPageController controller) {
  return Container(
    width: context.width,
    height: 291.h,
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Obx(() =>
                  SizedBox(height: controller.mindLessWord.value ? 8.h : 34.h)),
              Obx(
                () => Visibility(
                  visible: controller.mindLessWord.value,
                  child: Text(
